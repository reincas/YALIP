...
MATERIAL = {
    ...
    # Silica glass from [6]
    "SiO2": Sellmeier(0.6961663, 0.0684043, 0.4079426, 0.1162414, 0.8974794, 9.896161),
    # LaF3 ordinary ray [Laiho1983]
    "LaF3/o": Sellmeier(1 / 0.6505, math.sqrt(5.044e-3 / 0.6505), 0.0, 0.0, 0.0, 0.0),
    # LaF3 extraordinary ray [Laiho1983]
    "LaF3/e": Sellmeier(1 / 0.6600, math.sqrt(5.093e-3 / 0.6600), 0.0, 0.0, 0.0, 0.0),
}
...
def config2ion(config):
    ...
    num = int(config[1:])
    print(num)
    assert 0 <= num < len(LANTHANIDES), f">{num}<"
